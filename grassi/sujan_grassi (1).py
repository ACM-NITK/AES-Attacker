...
Original file is located at
    https://colab.research.google.com/drive/1ABgrCMI9UmPGvL13k5XamBEQVg0olHOj
"""
						...
						for k2 in range(k1+1,256):
							for l1 in range(256):
								for l2 in range(l1+1,256):
									pl2[0], pl2[5], pl2[10], pl2[15] = chr(i2), chr(j2), chr(k2),chr(l2)
									pl1[0], pl1[5], pl1[10], pl1[15] =chr(i1), chr(j1), chr(k1),chr(l1)
...
for i in range(256):
	for j in range(256):
		for k in range(256):
			for l in range(256):
				key_guess = [chr(i)] + [chr(0)]*4 + [chr(j)] + [chr(0)]*4 + [chr(k)] + [chr(0)]*4 + [chr(l)]
